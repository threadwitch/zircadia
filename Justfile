...
build:
    ...
    podman build -t zircadia:latest --build-arg BASE_IMAGE=ghcr.io/zirconium-dev/zirconium:latest@sha256:4ef030561d32ba6f20f6d43faea22b891762d740084d241c5c769904a2a70986 .
