...
dnf -y --best --repo=secureblue download trivalent
...
dnf -y --repo=secureblue download "${trivalent_selinux_pkg}"
...
dnf -y --setopt=localpkg_gpgcheck=True --setopt=install_weak_deps=False \
